...
{
    public class MinimumPerimeterAlgorithm : CalipersBaseClass
    {
        private double tempPerim { get; set; }
        private RectangleStruct perimStruct;

        public MinimumPerimeterAlgorithm(Form1 form)
            : base(form)
        {
        }
        ...
        public override void NextButton()
        {
            ...
            else
            {
                ...
                form.g.DrawEllipse(Utility.blackPen, perimStruct.GetC1().CenterPoint.X - 5, perimStruct.GetC1().CenterPoint.Y - 5, 10, 10);
                form.g.DrawEllipse(Utility.blackPen, perimStruct.GetC2().CenterPoint.X - 5, perimStruct.GetC2().CenterPoint.Y - 5, 10, 10);
                form.g.DrawEllipse(Utility.blackPen, perimStruct.GetC3().CenterPoint.X - 5, perimStruct.GetC3().CenterPoint.Y - 5, 10, 10);
                form.g.DrawEllipse(Utility.blackPen, perimStruct.GetC4().CenterPoint.X - 5, perimStruct.GetC4().CenterPoint.Y - 5, 10, 10);

                //Redraw the rectangle
                form.g.DrawLine(Utility.redPen, perimStruct.GetC1().P1, perimStruct.GetC1().CenterPoint);
                form.g.DrawLine(Utility.redPen, perimStruct.GetC1().CenterPoint, perimStruct.GetC1().P2);

                form.g.DrawLine(Utility.redPen, perimStruct.GetC2().P1, perimStruct.GetC2().CenterPoint);
                form.g.DrawLine(Utility.redPen, perimStruct.GetC2().CenterPoint, perimStruct.GetC2().P2);

                form.g.DrawLine(Utility.redPen, perimStruct.GetC3().P1, perimStruct.GetC3().CenterPoint);
                form.g.DrawLine(Utility.redPen, perimStruct.GetC3().CenterPoint, perimStruct.GetC3().P2);

                form.g.DrawLine(Utility.redPen, perimStruct.GetC4().P1, perimStruct.GetC4().CenterPoint);
                form.g.DrawLine(Utility.redPen, perimStruct.GetC4().CenterPoint, perimStruct.GetC4().P2);
        ...
        protected override void DrawInitialSupportLines()
        {
            ...
            CaliperD.P1 = new Point(form.firstPolygon.MinXPoint.X, -999999);
            CaliperD.P2 = new Point(form.firstPolygon.MinXPoint.X, 999999);
